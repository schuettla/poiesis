...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::imagegen::download_image_catalog_model_cmd,
            ...
            commands::endpoints::add_endpoint_cmd,
            commands::endpoints::update_endpoint_cmd,
            commands::endpoints::set_endpoint_enabled_cmd,
